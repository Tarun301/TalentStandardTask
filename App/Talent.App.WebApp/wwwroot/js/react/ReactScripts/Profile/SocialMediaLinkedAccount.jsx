...
export default class SocialMediaLinkedAccount extends React.Component {
    ...
    renderDisplay() {
        ...
        return (
            <div className='row'>
                <div className="ui sixteen wide column">
                <button className="ui linkedin button" style={{width:'200px'}}  onClick={this.openLinkedIn}>
                <i aria-hidden="true" className="linkedin icon"></i>
                LinkedIn
                </button>&nbsp;&nbsp;&nbsp;&nbsp;
                <button className="ui teal button" style={{width:'200px'}}  onClick={this.openGithub}>
                <i aria-hidden="true" className="github icon"></i>
                GitHub
                </button>
                <button type="button" className="ui right floated secondary button" onClick={this.openEdit}>Edit</button>
                </div>
            </div>
            )
